...
# -*- coding: utf-8 -*-
"""
Визуализация кодов, полученных методом main_da, с использованием классического MDS.

Берёт изображения указанных цифр из набора MNIST, кодирует их по правилам
approach main_da и строит 2D-раскладку методом классического MDS по косинусному
...
def main() -> None:
    ...
    ax.set_title("Korvin approach MDS")
    fig.tight_layout()
